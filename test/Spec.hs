...
testInt = TestCase (do
  ...
  -- TODO: assertEqual "should parse int decimal start" (Just ("", YamlScalar (YamlInt 685230))) (runParser yamlP "__685230")
  -- TODO: assertEqual "should parse int decimal end" (Just ("", YamlScalar (YamlInt 685230))) (runParser yamlP "685230__")
  -- TODO: assertEqual "should parse int decimal start and end" (Just ("", YamlScalar (YamlInt 685230))) (runParser yamlP "__685230__")
...
testFloat = TestCase (do
  ...
  -- TODO: assertEqual "should parse float scientific notation positive " (Just ("", YamlScalar (YamlFloat 685230.15))) (runParser yamlP "6.8523015e+5")
  -- TODO: assertEqual "should parse float positive scientific notation positive" (Just ("", YamlScalar (YamlFloat 685230.15))) (runParser yamlP "+6.8523015e+5")
  -- TODO: assertEqual "should parse float negative scientific notation positive" (Just ("", YamlScalar (YamlFloat (-685230.15)))) (runParser yamlP "-6.8523015e+5")
  -- TODO: assertEqual "should parse float scientific notation negative " (Just ("", YamlScalar (YamlFloat 685230.15))) (runParser yamlP "68523015000.0e-5")
  -- TODO: assertEqual "should parse float positive scientific notation negative" (Just ("", YamlScalar (YamlFloat 685230.15))) (runParser yamlP "+68523015000.0e-5")
  -- TODO: assertEqual "should parse float negative scientific notation negative" (Just ("", YamlScalar (YamlFloat (-685230.15)))) (runParser yamlP "-68523015000.0e-5")
